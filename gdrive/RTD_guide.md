...
Important disclaimer: lines beginning with User is the lines we enter and those beginning with Console are the answers of the system. "root@[Droplet_Name]" is just there for illustration, to help you follow the process (you don't actually have to enter this part of the line, just the code after).
